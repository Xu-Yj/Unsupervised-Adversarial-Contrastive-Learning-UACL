...
class UACL(nn.Module):
    def __init__(self, net, image_size=128, hidden_layer=-2, projection_size=256, projection_hidden_size=4096,
                 augment_fn=None, augment_fn2=None, moving_average_decay=0.99):
        super().__init__()


        # print(moving_average_decay)
        DEFAULT_AUG = nn.Sequential(
            ...
            # augs.Normalize(mean=torch.tensor([0.4824181, 0.48960114, 0.45031863]), std=torch.tensor([0.19409822, 0.181766, 0.1756254]))
        )
